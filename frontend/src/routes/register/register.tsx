        ...
        <div className="min-h-screen lg:p-0 bg-black p-5">
            <div className="lg:grid grid-cols-2 items-start justify-center mx-auto">
                <div className="min-h-screen hidden lg:block relative">
                    <img src="/images/auth_image.jpeg" alt="Login Image" className="h-full  w-full absolute object-cover inset-0" />
                </div>
                <div className="h-full lg:p-14 2xl:p-28">
                    ...
                    <form action="" className="flex-1 w-full mb-5" autoComplete="false" aria-autocomplete="none">
                        <div className="flex flex-col gap-3 mb-4">
                            <input type="text" id="name" className="block w-full px-3 py-3 text-sm font-bold text-white  bg-transparent rounded-lg outline outline-white outline-1  md:max-w-lg" placeholder="Full Name" />
                        </div>
                        <div className="flex flex-col gap-3 mb-4">
                        ...
                        <div className="flex flex-col gap-3 mb-4">
                            <input type="tel" id="phone" className="block w-full px-3 py-3 text-sm font-bold text-white  bg-transparent rounded-lg outline outline-white outline-1  md:max-w-lg" placeholder="Phone Number" />
                        </div>
                        <div className="flex flex-col gap-3 mb-4">
                            <input
                                ...
                                type="text"
                                placeholder="Country"
                                id="location" className="block w-full px-3 py-3 text-sm font-bold text-white bg-transparent rounded-lg outline outline-white outline-1 md:max-w-lg" defaultValue={country}>
                            </input>
                            {countryList && (
                    ...
                    <div className="mt-12">
                        <p className="text-sm font-bold text-white ">Have an account? <Link to="/login" className="font-bold text-primary-dark-pink">Sign in</Link></p>
                    </div>
                </div>
            </div>
        </div>
