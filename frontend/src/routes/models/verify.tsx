    ...
    return (
        <div className="min-h-[70vh] flex items-center justify-center p-2">
            <div className="text-center lg:w-3/5">
                <img src="/images/My project-1 (49) 1.png" alt="" className="w-40 h-40 rounded-lg object-cover mx-auto my-2" />
...
export function ModelVerificationSuccess() {
    return (
        <div className="min-h-[70vh] flex items-center justify-center p-2">
            <div className="text-center lg:w-3/5">
                <img src="/images/fi-rr-thumbs-up.png" alt="" className="w-16 h-16 rounded-lg object-cover mx-auto my-2" />
