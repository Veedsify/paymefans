        ...
        <div className="min-h-screen p-5 md:p-7">
            <div className="max-w-screen-xl pt-12 mx-auto mb-24 md:mt-16">
                ...
                <div className="grid grid-cols-3 max-w-96 mx-auto mb-12">
                    <div>
                        <img src="/site/front_verification.svg" alt="" className="block text-center mx-auto mb-4 aspect-square rounded-xl" />
                        <p className="text-center font-medium">FRONT</p>
                    </div>
                    <div>
                        <img src="/site/back_verification.svg" alt="" className="block text-center mx-auto mb-4 aspect-square rounded-xl" />
                        <p className="text-center font-medium">BACK</p>
                    </div>
                    <div>
                        <img src="/site/side_verification.svg" alt="" className="block text-center mx-auto mb-4 aspect-square rounded-xl" />
