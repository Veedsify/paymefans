    ...
    <div className="p-4 lg:block hidden lg:col-span-3">
      <div className="max-w-[450px]">
        ...
        <div className="flex align-middle justify-between pb-12">
          ...
          <span>
            <Link to="/models" className="bg-primary-dark-pink text-white px-3 text-sm py-1 font-semibold rounded-md">View All</Link>
          </span>
        </div>
        ...
        <div className="flex align-middle justify-between  my-8">
          ...
          <span>
            <Link to="/hookup" className="bg-primary-dark-pink text-white px-3 text-sm py-1 font-semibold rounded-md">View All</Link>
          </span>
        </div>
        <div className="grid gap-4 lg:gap-6 grid-cols-3 ">
          <HookupSubscription />
